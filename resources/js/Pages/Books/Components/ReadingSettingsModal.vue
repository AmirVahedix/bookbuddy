            ...
            >
                ...
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-lg font-bold text-slate-900 dark:text-white font-sans">{{ t('settings') }}</h3>
                    </div>
                    <button
                        @click="close"
                ...
                <div class="space-y-6">
                    ...
                    <div class="text-start">
                        <label class="block text-xs font-extrabold uppercase tracking-wider text-slate-400 dark:text-slate-500 mb-3">{{ t('font_family') }}</label>
                    ...
                    <!-- Text Size Section -->
                    <div class="text-start">
                        <label class="block text-xs font-extrabold uppercase tracking-wider text-slate-400 dark:text-slate-500 mb-3">{{ t('font_size') }}</label>
                        <div class="grid grid-cols-3 gap-3">
                            <button

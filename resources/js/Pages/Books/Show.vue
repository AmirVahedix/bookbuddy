...
<template>
    ...
    <div class="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100 flex flex-col transition-colors duration-200">
        <!-- Navigation Header -->
        <header class="border-b border-slate-200 dark:border-slate-900 bg-white/80 dark:bg-slate-950/80 backdrop-blur sticky top-0 z-40 transition-colors duration-200 pt-[env(safe-area-inset-top)]">
                ...
                <div class="flex flex-col sm:flex-row gap-5 sm:gap-6 md:gap-8 items-stretch relative z-10">
                    ...
                    <div class="flex-1 flex flex-col justify-between self-stretch min-w-0">
                        ...
                        <div class="mt-6 border-t border-slate-100 dark:border-slate-800 pt-5 flex flex-col xl:flex-row items-stretch xl:items-center justify-between gap-5">
                            <!-- Progress Form -->
                            <form @submit.prevent="submitProgress" class="flex flex-wrap items-end gap-3 sm:gap-4">
                                ...
                                <div class="flex flex-col w-28">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <input
                                            ...
                                            class="w-full px-3 py-2 text-xs font-semibold rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center focus:outline-none focus:border-violet-500"
                                        />
                                ...
                                <button
                                    ...
                                    class="px-4 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 dark:bg-white dark:hover:bg-slate-100 text-white dark:text-slate-950 text-xs font-bold transition-all duration-200 hover:scale-[1.02] cursor-pointer"
                                >
                                    Save
                                </button>
                            </form>
                ...
                <div class="order-2 lg:order-1 rounded-3xl border border-slate-200 dark:border-slate-900 bg-white dark:bg-slate-900/40 p-6 shadow">
                        ...
                        <div v-else class="text-center py-16 text-slate-400 dark:text-slate-600">
                            ...
                            <p class="text-xs text-slate-500 max-w-sm mx-auto">
                                {{ props.summaries.length > 0 ? "Adjust your search filters to find summaries." : "Start by generating an AI summary of a section from Table of Contents or while reading." }}
                            </p>
                        </div>
                    </div>
